...
\[
\mathbf{H}_f = \begin{bmatrix}\frac{\partial^2 f}{\partial x^2} & \frac{\partial^2 f}{\partial x \partial y} \\[0.6em]
    \frac{\partial^2 f}{\partial y \partial x} & \frac{\partial^2 f}{\partial y^2}\end{bmatrix} = \begin{bmatrix}
        2 & 2 \\ 2 & 4
    \end{bmatrix},
\]
...
%    \end{cases}.
%\]
Now we compute the proximal operator of $f$ as $\mbox{prox}_f = (I + \partial f)^{-1}$ .
...
where the values at $(-3, -1)$ and $(1, 3)$ corresponds to the discontinuities of $(I + \partial f) (x)$.
